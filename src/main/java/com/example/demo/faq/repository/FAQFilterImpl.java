...
import com.example.demo.common.domain.QCategoryEntity;
...
public class FAQFilterImpl extends QuerydslRepositorySupport implements FAQFilter {
    ...
    public Page<FAQEntity> list(Pageable pageable) {
        ...
        query.leftJoin(faqEntity.category, categoryEntity).fetchJoin();
    ...
    @Override
    public Page<FAQEntity> listByCategory(Long cno, Pageable pageable) {
        QFAQEntity faqEntity = QFAQEntity.fAQEntity;
        QCategoryEntity categoryEntity = QCategoryEntity.categoryEntity;
        ...
        // 카테고리로 필터링
        query.where(categoryEntity.cno.eq(cno));
