package com.tripwhiz.tripwhizadminback.cart.repository;

import com.tripwhiz.tripwhizadminback.cart.entity.Cart;
...
public interface CartRepository extends JpaRepository<Cart, Long> {
    ...
    // 멤버별 장바구니 리스트 조회
    @Query("SELECT new com.tripwhiz.tripwhizadminback.cart.dto.CartListDTO(m.email, c.bno, p.pno, p.pname, p.price, c.qty, c.delFlag) " +
            "FROM Cart c " +
            "JOIN c.member m " +
            "JOIN c.product p " +
    ...
    // 장바구니에 있는 모든 항목 조회
//    @Query("SELECT new com.tripwhiz.tripwhizadminback.cart.dto.CartProductDTO(" +
