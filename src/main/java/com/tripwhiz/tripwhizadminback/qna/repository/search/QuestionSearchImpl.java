...
import com.tripwhiz.tripwhizadminback.qna.domain.QQuestions;
...
public class QuestionSearchImpl extends QuerydslRepositorySupport implements QuestionSearch {
    ...
    @Override
    public Page<Questions> list(String keyword, QnAStatus status, Pageable pageable) {

        // Q 엔티티를 사용해 검색할 필드를 정의합니다.
        QQuestions questions = QQuestions.questions;

        JPQLQuery<Questions> query = from(questions);
        ...
        List<Questions> list = query.fetch();
