...
public class BoardRepositoryTests {
    ...
    public void testUpdateBoard() {
        ...
        BoardEntity board = boardRepository.findById(bno).orElseThrow();
        board.setTitle("업데이트된 제목");
        board.setBcontent("업데이트된 내용");
        boardRepository.save(board);

        BoardEntity updatedBoard = boardRepository.findById(bno).orElseThrow();
    ...
    public void testDeleteBoard() {
        ...
        Optional<BoardEntity> deletedBoard = boardRepository.findById(bno);
